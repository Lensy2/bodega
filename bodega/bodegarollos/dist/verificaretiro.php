                    ...
                    <div class="col-12">
                        <form action=" " method="post" class="card">
                            <div class="card-header">
                                <h3 class="card-title">Retirar Rollos</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                        <table>
                                                <td><form action="verificaretiro2.php" method=POST >
                                                        <h3> Fecha      <input type=text   name=fecha required value= <?echo $fecha?> />*<br><br> </h3>
                                                        <h3> Ubicación  <input type=text   name=ubicacion required value= <?echo $ubicacion?> />*<br><br> </h3>
