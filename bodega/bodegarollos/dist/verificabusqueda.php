...
$resultado = &$conexion->Execute("SELECT DISTINCT B.ROLLO,B.UBICACION,C.PESON
                    ...
                    <div class="col-12">
                        <form action=" " method="post" class="card">
                            <div class="card-header">
                                <h3 class="card-title">Buscar Rollos</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
